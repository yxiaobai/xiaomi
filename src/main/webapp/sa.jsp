...
<head>
    ...
    <link rel="stylesheet" href="//s01.mifile.cn/css/base.min.css?v2017a14" />
            ...
            <div class="section section-address">
                ...
                <div class="section-body clearfix" id="J_addressList">
                    ...
                    <div class="address-item J_addressItem "
                         data-address_id='10170315751917002'
                         data-consignee='aa'
                         data-tel='131****5812'
                         data-province_id='17'
                         data-province_name='河南'
                         data-city_id='187'
                         data-city_name='郑州市'
                         data-district_id='1809'
                         data-district_name='金水区'
                         data-area='1809024'
                         data-address='河南省郑州市金水区文化路'
                         data-tag_name='sas'
                         data-editable='Y'
                         data-neededit='N'
                    >
            ...
            <div class="section section-options section-invoice clearfix">
                ...
                <div class="section-body clearfix">
                    <ul class="J_optionList options options-list  J_tabSwitch clearfix">
                        ...
                        <li data-type="invoice" data-invoice-type="personal" class="hide J_option" id="J_paperInvoice">
                            普通发票（纸质）
                        </li>
                    </ul>
                    ...
                    <div class="paper-invoice-company" id="J_invoiceTitleBox">
                        <div class="form-section">
                            <label class="input-label" for="invoice_title">填写个人 / 单位名称</label>
                            <input class="input-text" type="text" id="invoice_title" value="个人" name="invoice_title" />
                        </div>
                        <p>发票内容：购买商品明细</p>
                    </div>
                    <div class="tab-container">
                        <div class="tab-content hide"></div>
                        <div class="tab-content hide e-invoice-detail">
                            电子发票法律效力、基本用途及使用规定同纸质发票。不随商品寄送。<a href="javascript:void(0);" id="J_showEinvoiceDetail">什么是电子发票 <i class="icon-qa">?</i></a>
                            <div class="e-invoice-qa hide" id="J_einvoiceDetail">
                                ...
                                <a href="http://bbs.xiaomi.cn/thread/index/tid/9385999" target="_blank">了解详情&gt;</a>
                            </div>
                        </div>

                        <div class="tab-content hide paper-invoice-detail">
                            <!--   <ul class="J_optionList options options-list J_tabSwitch clearfix">
                                  <li data-type="invoice" data-invoice-type="personal" class="hide J_option">
                                      个人
                                  </li>
                                  <li data-type="invoice" data-invoice-type="company" class="hide J_option">
                                      单位
                                  </li>
                              </ul> -->
                            <!-- <div class="tab-container">
            ...
            <div class="section section-goods">
                ...
                <div class="section-body">
                    <ul class="goods-list" id="J_goodsList">
                        ...
                        <li class="clearfix">
                            <div class="col col-img">
                                <img src="//i1.mifile.cn/a1/T1AaJQBbZT1RXrhCrK!30x30.jpg" width="30" height="30">
                            </div>
                            <div class="col col-name">
                ...
                <div class="money-box" id="J_moneyBox">
                    <ul>
                        ...
                        <li class="clearfix total-price">
                            <label>应付总额：</label>
                            <span class="val"><em data-id="J_totalPrice">998</em>元</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<script src="//s01.mifile.cn/js/base.min.js?v2017a14"></script>
<script>
    (function() {
...
<script type="text/javascript" src="js/order/checkout.min.js"></script>
